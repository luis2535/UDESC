...
class Ant:
    ...
    def try_drop(self):
        ...
        if self.is_carrying_object and position not in object_positions:
            nearby_vet = self.nearby_objects()
            similarity = similaridade(nearby_vet, 9, alfa)
...
class Object:
    def __init__(self, x, y, dado):
        ...
        self.data = dado
    def draw(self, screen):
        if self.data[0] > 9 and self.data[0] < 11 and self.data[1] > 9 and self.data[1] < 11:
            pygame.draw.rect(screen, RED, (self.x, self.y, GRID_SIZE, GRID_SIZE))
        elif self.data[0] > 11 and self.data[0] < 13 and self.data[1] > 9 and self.data[1] < 12:
            pygame.draw.rect(screen, GREEN, (self.x, self.y, GRID_SIZE, GRID_SIZE))
        elif self.data[0] > 10 and self.data[0] < 12 and self.data[1] > 10 and self.data[1] < 13:
            pygame.draw.rect(screen, BLUE, (self.x, self.y, GRID_SIZE, GRID_SIZE))
        elif self.data[0] > 8 and self.data[0] < 11 and self.data[1] > 11 and self.data[1] < 13:
            pygame.draw.rect(screen, YELLOW, (self.x, self.y, GRID_SIZE, GRID_SIZE))
        elif self.data[0] > 7 and self.data[0] < 9 and self.data[1] > 10 and self.data[1] < 12:
            pygame.draw.rect(screen, ORANGE, (self.x, self.y, GRID_SIZE, GRID_SIZE))
        elif self.data[0] > 7 and self.data[0] < 9 and self.data[1] > 8 and self.data[1] < 10:
            pygame.draw.rect(screen, PURPLE, (self.x, self.y, GRID_SIZE, GRID_SIZE))
        elif self.data[0] > 8 and self.data[0] < 11 and self.data[1] > 7 and self.data[1] < 9:
            pygame.draw.rect(screen, PINK, (self.x, self.y, GRID_SIZE, GRID_SIZE))
        elif self.data[0] > 10 and self.data[0] < 12 and self.data[1] > 7 and self.data[1] < 9:
            pygame.draw.rect(screen, CYAN, (self.x, self.y, GRID_SIZE, GRID_SIZE))
        elif self.data[0] > 15 and self.data[0] < 18 and self.data[1] > 9 and self.data[1] < 11:
            pygame.draw.rect(screen, LIME, (self.x, self.y, GRID_SIZE, GRID_SIZE))
        elif self.data[0] > 13 and self.data[0] < 15 and self.data[1] > 14 and self.data[1] < 16:
            pygame.draw.rect(screen, TEAL, (self.x, self.y, GRID_SIZE, GRID_SIZE))
        elif self.data[0] > 8 and self.data[0] < 10 and self.data[1] > 15 and self.data[1] < 18:
            pygame.draw.rect(screen, GOLD, (self.x, self.y, GRID_SIZE, GRID_SIZE))
        elif self.data[0] > 3 and self.data[0] < 6 and self.data[1] > 12 and self.data[1] < 14:
            pygame.draw.rect(screen, SILVER, (self.x, self.y, GRID_SIZE, GRID_SIZE))
        elif self.data[0] > 3 and self.data[0] < 6 and self.data[1] > 6 and self.data[1] < 8:
            pygame.draw.rect(screen, INDIGO, (self.x, self.y, GRID_SIZE, GRID_SIZE))
        elif self.data[0] > 7 and self.data[0] < 10 and self.data[1] > 3 and self.data[1] < 5:
            pygame.draw.rect(screen, BROWN, (self.x, self.y, GRID_SIZE, GRID_SIZE))
        elif self.data[0] > 13 and self.data[0] < 15 and self.data[1] > 4 and self.data[1] < 6:
