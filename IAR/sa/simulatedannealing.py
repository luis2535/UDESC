...
class Annealing:
    def __init__(self, sat: ThreeSAT, max_iterations, cooling_schedule = 9, temp = 1, temp_min = 0.0001, sa_max = 1) -> None:
        self.sat = sat
    ...
    def calc_temp(self, it):
        match self.cooling_schedule:
            ...
            case 9:
                return self.calc_temp_9(it)

    def calc_temp_9(self, it: int, t: int = 2):
        return ((1 - it/ self.max_iterations)) ** t
    ...
    def run(self):
        ...
        while self.temp > self.temp_min:
            ...
            self.score_list = np.append(self.score_list, self.score)
            iterations += 1
