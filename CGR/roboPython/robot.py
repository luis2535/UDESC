...
def display():
    ...
    robo.rightArmFAngle = cos(angle / 180.0 * 4.0 * pi) * 22.5
    robo.rightArmSAngle = (sin(angle / 180.0 * 4.0 * pi) + 1) * 5.0
    robo.rightElbowFAngle = (-sin(angle / 180.0 * 4.0 * pi) + 1.1) * 38.0
    robo.leftArmFAngle = cos((angle + 180.0) / 180.0 * 4.0 * pi) * -22.5
    robo.leftArmSAngle = (sin(angle / 180.0 * 4.0 * pi) + 1) * -5.0
    robo.leftElbowFAngle = (sin((angle + 90.0) / 180.0 * 4.0 * pi) + 1.1) * 38.0
...
glutCreateWindow("Robo - Gabriel Anselmo e Luís")
