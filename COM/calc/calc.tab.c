...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_mixed_expr = 16,                /* mixed_expr  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "T_INT", "T_REAL",
  "T_PLUS", "T_MINUS", "T_MULTIPLY", "T_DIVIDE", "T_LEFT", "T_RIGHT",
  "T_NEWLINE", "T_QUIT", "$accept", "calculation", "line", "mixed_expr",
  "expr", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 5: /* line: mixed_expr T_NEWLINE  */
#line 39 "calc.y"
                                                                { printf("\tResultado: %f\n", (yyvsp[-1].fval));}
#line 1106 "calc.tab.c"
    break;

  case 6: /* line: expr T_NEWLINE  */
#line 40 "calc.y"
                                                                                { printf("\tResultado: %i\n", (yyvsp[-1].ival)); }
...
#line 1118 "calc.tab.c"
  ...
  case 8: /* mixed_expr: T_REAL  */
#line 44 "calc.y"
                                                                        { (yyval.fval) = (yyvsp[0].fval); }
#line 1124 "calc.tab.c"
    break;

  case 9: /* mixed_expr: mixed_expr T_PLUS mixed_expr  */
#line 45 "calc.y"
                                                { (yyval.fval) = (yyvsp[-2].fval) + (yyvsp[0].fval); }
#line 1130 "calc.tab.c"
    break;

  case 10: /* mixed_expr: mixed_expr T_MINUS mixed_expr  */
#line 46 "calc.y"
                                                { (yyval.fval) = (yyvsp[-2].fval) - (yyvsp[0].fval); }
#line 1136 "calc.tab.c"
    break;

  case 11: /* mixed_expr: mixed_expr T_MULTIPLY mixed_expr  */
#line 47 "calc.y"
                                                { (yyval.fval) = (yyvsp[-2].fval) * (yyvsp[0].fval); }
#line 1142 "calc.tab.c"
    break;

  case 12: /* mixed_expr: mixed_expr T_DIVIDE mixed_expr  */
#line 48 "calc.y"
                                                        { (yyval.fval) = (yyvsp[-2].fval) / (yyvsp[0].fval); }
#line 1148 "calc.tab.c"
    break;

  case 13: /* mixed_expr: T_LEFT mixed_expr T_RIGHT  */
#line 49 "calc.y"
                                                        { (yyval.fval) = (yyvsp[-1].fval); }
#line 1154 "calc.tab.c"
    break;

  case 14: /* mixed_expr: expr T_PLUS mixed_expr  */
#line 50 "calc.y"
                                                                { (yyval.fval) = (yyvsp[-2].ival) + (yyvsp[0].fval); }
#line 1160 "calc.tab.c"
    break;

  case 15: /* mixed_expr: expr T_MINUS mixed_expr  */
#line 51 "calc.y"
                                                                { (yyval.fval) = (yyvsp[-2].ival) - (yyvsp[0].fval); }
#line 1166 "calc.tab.c"
    break;

  case 16: /* mixed_expr: expr T_MULTIPLY mixed_expr  */
#line 52 "calc.y"
                                                        { (yyval.fval) = (yyvsp[-2].ival) * (yyvsp[0].fval); }
#line 1172 "calc.tab.c"
    break;

  case 17: /* mixed_expr: expr T_DIVIDE mixed_expr  */
#line 53 "calc.y"
                                                                { (yyval.fval) = (yyvsp[-2].ival) / (yyvsp[0].fval); }
#line 1178 "calc.tab.c"
    break;

  case 18: /* mixed_expr: mixed_expr T_PLUS expr  */
#line 54 "calc.y"
                                                                { (yyval.fval) = (yyvsp[-2].fval) + (yyvsp[0].ival); }
#line 1184 "calc.tab.c"
    break;

  case 19: /* mixed_expr: mixed_expr T_MINUS expr  */
#line 55 "calc.y"
                                                                { (yyval.fval) = (yyvsp[-2].fval) - (yyvsp[0].ival); }
#line 1190 "calc.tab.c"
    break;

  case 20: /* mixed_expr: mixed_expr T_MULTIPLY expr  */
#line 56 "calc.y"
                                                        { (yyval.fval) = (yyvsp[-2].fval) * (yyvsp[0].ival); }
#line 1196 "calc.tab.c"
    break;

  case 21: /* mixed_expr: mixed_expr T_DIVIDE expr  */
#line 57 "calc.y"
                                                                { (yyval.fval) = (yyvsp[-2].fval) / (yyvsp[0].ival); }
#line 1202 "calc.tab.c"
    break;

  case 22: /* mixed_expr: expr T_DIVIDE expr  */
#line 58 "calc.y"
...
#line 1226 "calc.tab.c"
  ...
  case 26: /* expr: expr T_MULTIPLY expr  */
#line 64 "calc.y"
                                                                { (yyval.ival) = (yyvsp[-2].ival) * (yyvsp[0].ival); }
#line 1232 "calc.tab.c"
    break;

  case 27: /* expr: T_LEFT expr T_RIGHT  */
#line 65 "calc.y"
...
void yyerror(const char* s) {
	fprintf(stderr, "Erro de anÃ¡lise (sintÃ¡tica): %s\n", s);
	exit(1);
}
